...
export const MATCH_BET_TYPES: BetDef[] = [
  ...
  },
  {
    ...
    description: "Gissa exakt slutresultat (+400p bonus om rätt)",
    points: 400,
    category: "match",
    inputType: "number",
    bonusPoints: 400, // flat +400 bonus on top if exact
  },
  {
    id: "first_scorer",
  ...
  },
  {
    ...
    description: "Totalt antal gula kort i matchen (±1 = 40p, exakt = 75p)",
    points: 75,
    category: "match",
    inputType: "number",
  },
...
export const POINTS_BREAKDOWN: Record<string, string> = {
  total_goals: "Exakt: 1 500p · ±2 mål: 750p · ±5 mål: 375p",
  yellow_cards: "Exakt: 75p · ±1 kort: 40p",
  exact_score: "+400p bonus om exakt rätt",
};
